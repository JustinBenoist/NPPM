...
class _frnn_grid_gathering(Function):
    ...
    def forward(ctx,
        ...
        # perform search on the grid
        if not is_cppm:
            value = _C.gather_ppm_cuda(sorted_points1, sorted_points2,
                                            lengths1, lengths2, pc2_grid_off,
                                            sorted_points1_idxs,
                                            sorted_points2_idxs, 
                                            grid_params_cuda,
            ...
            value, total_count, min_counts, photon_counts = _C.gather_cppm_cuda(sorted_points1, sorted_points2,
                                            lengths1, lengths2, pc2_grid_off,
                                            sorted_points1_idxs,
                                            sorted_points2_idxs, 
                                            grid_params_cuda,
        ...
        ctx.mark_non_differentiable(grid_params_cuda)
        if not is_cppm:
            return (value, radii, sorted_points2, pc2_grid_off, sorted_points2_idxs,
                grid_params_cuda)
        return (value, radii, total_count, min_counts, photon_counts, sorted_points2,
...
def frnn_grid_photon_gather(
    ...
    if grid is not None:
        if is_cppm:
            value, radii, total_count, min_counts, photon_counts, sorted_points2, pc2_grid_off, sorted_points2_idxs, grid_params_cuda = _frnn_grid_gathering.apply(
            ...
            value, radii, sorted_points2, pc2_grid_off, sorted_points2_idxs, grid_params_cuda = _frnn_grid_gathering.apply(
            g_pos, p_pos, lengths1, lengths2, r,
            p_normals, p_dirs, p_rough, p_is_glossy, p_flux,
            g_normals, g_dirs, g_rough, g_is_glossy, g_eta, g_k, g_albedo, 
            grid[0], grid[1], grid[2], grid[3], radius_cell_ratio, 
    ...
    # TODO: also change this in the c++/cuda code?
    if is_cppm:
        return value, radii, total_count, min_counts, photon_counts, grid
    return value, radii, grid
...
class _frnn_grid_gathering_gauss(Function):
    ...
    def forward(ctx,
        ...
        # perform search on the grid
        value, value_2 = _C.gather_ours_gauss_cuda(sorted_points1, sorted_points2,
                                        lengths1, lengths2, pc2_grid_off,
                                        sorted_points1_idxs,
                                        sorted_points2_idxs, 
                                        grid_params_cuda,
        ...
        return (value, value_2, sorted_points2, pc2_grid_off, sorted_points2_idxs,
                grid_params_cuda)
...
def frnn_grid_photon_gauss_gather(
    ...
    if grid is not None:
        value, value_2, sorted_points2, pc2_grid_off, sorted_points2_idxs, grid_params_cuda = _frnn_grid_gathering_gauss.apply(
